...
# top 5 attackers
    ...
    def insert_packet(self, data):
        ...
        # DUPLICATE FILTER (TOP me add karo)
        key = (data["src"], data["dst"], data["proto"], data["attack_type"])

        if hasattr(self, "last_key") and self.last_key == key:
            return
        ...
        # ✅ ALERT ke liye alag tag add karo
